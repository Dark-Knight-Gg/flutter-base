...
class NavigatorHelper {
  ...
  static navigate(NavigateEvent event,
      void Function(dynamic) onResponse,) async {
    switch (event.type) {
  ...
  static Future<T?>? pushAndRemoveUntil<T>(Route<T> newRoute,
  ...
  static Future<T?>?
  pushReplacementNamed<T extends Object?, TO extends Object?>(String routeName,
      {
        TO? result,
        Object? arguments,
      }) {
