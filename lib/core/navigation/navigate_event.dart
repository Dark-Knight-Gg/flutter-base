...
class NavigateEvent<T> {
  ...
  NavigateEvent.pushNamed(String routeName, {
    Object? arguments,
  }) : this._(
  ...
  NavigateEvent.pushNamedAndRemoveUntil(String routeName,
  ...
  NavigateEvent.pushReplacementNamed(String routeName, {
    dynamic result,
    dynamic arguments,
  }) : this._(
  ...
  NavigateEvent.popAndPushNamed(String routeName, {
    dynamic result,
    dynamic arguments,
  }) : this._(
